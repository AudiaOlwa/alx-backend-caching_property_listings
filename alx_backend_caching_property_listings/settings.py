...
SECRET_KEY = 'django-insecure-pv@5wu^5(fx(er4uihuk5i79!8@1^p)5go1%ywc*%=o2ux+vl0'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',  # ou 'postgres' si Django est dockerisé
        'PORT': '5432',
    }
}
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # ou 'redis:6379/1' si Docker réseau
        "OPTIONS": {
